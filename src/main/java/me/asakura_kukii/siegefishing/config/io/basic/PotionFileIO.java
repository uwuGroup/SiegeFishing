...
public class PotionFileIO extends FileIO {

    public static Class<?> dataClass = PotionData.class;
    public static Constructor<?> constructor;

    public enum Map {
        POTION_EFFECT_TYPE("potionEffectType", PotionEffectType.ABSORPTION, VerifierType.POTION, true),
        DURATION("duration", (int) 20, VerifierType.INTEGER, true),
        AMPLIFIER("amplifier", (int) 1, VerifierType.INTEGER, true),
        AMBIENT("ambient", false, VerifierType.BOOLEAN, true),
        PARTICLES("particles", false, VerifierType.BOOLEAN, true),
        ICON("icon", false, VerifierType.BOOLEAN, true);
