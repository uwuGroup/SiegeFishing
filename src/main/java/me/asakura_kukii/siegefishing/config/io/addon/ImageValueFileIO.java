...
public class ImageValueFileIO extends FileIO {

    public static Class<?> dataClass = ImageValueData.class;
    public static Constructor<?> constructor;

    public enum Map {
        IMAGE("image", null, VerifierType.IMAGE, true),
        REFERENCE_CHUNK("referenceChunk", null, VerifierType.CHUNK, true),
        VALUE_MIN("valueMin", (double) 0, VerifierType.DOUBLE, true),
        VALUE_MAX("valueMax", (double) 100, VerifierType.DOUBLE, true),
        VALUE_NORMAL("valueNormal", (double) 100, VerifierType.DOUBLE, true);
