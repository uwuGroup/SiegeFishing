...
import me.asakura_kukii.siegefishing.config.data.addon.AwardData;
...
public class AwardFileIO extends FileIO {

    public static Class<?> dataClass = AwardData.class;
    ...
    public enum Map {
        ...
        PARTICLE_DATA("particleData", new ParticleData("","",FileType.PARTICLE), VerifierType.FILE_DATA, false),
        SOUND_DATA("soundData", new SoundData("","",FileType.SOUND), VerifierType.FILE_DATA, false);
