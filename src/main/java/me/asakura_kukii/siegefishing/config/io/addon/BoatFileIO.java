...
public class BoatFileIO extends FileIO {

    public static Class<?> dataClass = BoatData.class;
    ...
    public enum Map {
        ...
        BOAT_CUSTOM_MODEL_DATA("boatCustomModelData", (int) 0, VerifierType.INTEGER, true);
