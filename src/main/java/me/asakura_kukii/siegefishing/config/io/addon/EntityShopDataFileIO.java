...
public class EntityShopDataFileIO extends FileIO {

    public static Class<?> dataClass = EntityShopData.class;
    public static Constructor<?> constructor;

    public enum Map {
        TAG("tag", "", VerifierType.STRING, true),
        FISH_SHOP_NAME("fishShopName", "", VerifierType.STRING, true),
        LEVEL_PRICE_MAP("levelPriceMap", null, VerifierType.MAP_INTEGER_DOUBLE, true);
