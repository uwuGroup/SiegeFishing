...
public class ExtraStringListFileIO extends FileIO {

    public static Class<?> dataClass = ExtraStringListData.class;
    public static Constructor<?> constructor;

    public enum Map {
        EXTRA_STRING_LIST("extraStringList", new ArrayList<String>(), VerifierType.LIST_STRING, false);
